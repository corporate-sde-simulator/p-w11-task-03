...
> **Welcome to Product-Track Week 11, Task 3!**
...
| `src/securityUtils.py` | Main source code - **has bugs to fix** |
| `src/userSearch.py` | Supporting code - **may also have bugs** |
| `tests/test_security.py` | Test file - **add your tests here** |
